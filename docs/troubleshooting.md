...
| Two projects can't reach each other over the network | They are in **different categories** (network-isolated) | Put both in the **same category** (Project → Settings) and redeploy; they then share one private Docker network |
